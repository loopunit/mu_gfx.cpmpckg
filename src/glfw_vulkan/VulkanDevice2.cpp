...
namespace FGC
{
	bool VulkanDevice2::InstanceVersion::operator==(const InstanceVersion& rhs) const
	{
	...
	=================================================
	*/
	VulkanDevice2::VulkanDevice2() : _vkLogicalDevice{VK_NULL_HANDLE}, _vkPhysicalDevice{VK_NULL_HANDLE}, _vkInstance{VK_NULL_HANDLE}
	{
	...
	*/
	...
	=================================================
	*/
	bool VulkanDevice2::HasInstanceExtension(StringView name) const
	{
	...
	=================================================
	*/
	bool VulkanDevice2::HasDeviceExtension(StringView name) const
	{
	...
	=================================================
	*/
	bool VulkanDevice2::SetObjectName(uint64_t id, NtStringView name, VkObjectType type) const
	{
	...
	=================================================
	*/
	void VulkanDevice2::GetQueueFamilies(VQueueMask mask, OUT VQueueFamilyIndices_t& result) const
	{
		result.clear();
	...
	=================================================
	*/
	VulkanDevice2Initializer::VulkanDevice2Initializer()
	{
	...
	*/
	...
	=================================================
	*/
	VulkanDevice2Initializer::InstanceVersion VulkanDevice2Initializer::GetInstanceVersion() const
	{
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::CreateInstance(
		NtStringView appName, NtStringView engineName, ArrayView<const char*> layers, ArrayView<const char*> extensions, InstanceVersion version, uint appVer, uint engineVer)
	{
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::SetInstance(VkInstance newInstance, ArrayView<const char*> instanceExtensions)
	{
		CHECK_ERR(not _vkInstance);
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::DestroyInstance()
	{
		if (not _vkInstance)
			return false;
	...
	*/
	namespace
	{
		...
		void WithPhysicalDevices(const VulkanDevice2& vulkan, Fn&& fn)
		{
			uint							 count = 0;
	...
	*/
	namespace
	{
	  ...
	  =================================================
	  */
	bool VulkanDevice2Initializer::ChooseDevice(StringView deviceName)
	{
		...
		WithPhysicalDevices(
			*this,
			...
			{
				bool math = not deviceName.empty() and (HasSubStringIC(prop.deviceName, deviceName) or HasSubStringIC(GetVendorNameByID(prop.vendorID), deviceName));
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::ChooseHighPerformanceDevice()
	{
		CHECK_ERR(_vkInstance);
		CHECK_ERR(not _vkLogicalDevice);
		...
		WithPhysicalDevices(
			*this,
			...
			{
				const bool is_gpu		 = (prop.deviceType == VK_PHYSICAL_DEVICE_TYPE_INTEGRATED_GPU or prop.deviceType == VK_PHYSICAL_DEVICE_TYPE_DISCRETE_GPU);
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::SetPhysicalDevice(VkPhysicalDevice newPhysicalDevice)
	{
		CHECK_ERR(_vkInstance);
		CHECK_ERR(not _vkLogicalDevice);
...
// VkPhysicalDeviceComputeShaderDerivativesFeaturesNV	computeShaderDerivatives;
	...
	*/
	namespace
	{
		bool SetupDeviceFeatures(VkPhysicalDevice pdev, DeviceFeatures& features, void** nextExt, ArrayView<const char*> extensions, const VulkanDevice2::InstanceVersion& version)
		{
			...
			const bool		  is_vk_1_1 = (version >= VulkanDevice2::InstanceVersion{1, 1});
			const bool		  is_vk_1_2 = (version >= VulkanDevice2::InstanceVersion{1, 2});
			...
			for (StringView ext : extensions)
			{
				...
				{
					enabled.descriptorIndexing = true;
					continue;
				}
#endif
#ifdef VK_NV_mesh_shader
				...
				{
					enabled.inlineUniformBlock = true;
					continue;
				}
#endif
#ifdef VK_NV_representative_fragment_test
				...
				{
					enabled.representativeFragmentTestNV = true;
					continue;
				}
#endif
#ifdef VK_NV_fragment_shader_barycentric
				...
				{
					enabled.fragmentShaderBarycentricNV = true;
					continue;
				}
#endif
#ifdef VK_NV_shader_image_footprint
				...
				{
					enabled.shadingRateImageNV = true;
					continue;
				}
#endif
#ifdef VK_KHR_shader_float16_int8
				...
				{
					enabled.shaderFloat16Int8 = true;
					continue;
				}
#endif
#ifdef VK_KHR_timeline_semaphore
				if (ext == VK_KHR_TIMELINE_SEMAPHORE_EXTENSION_NAME)
				{
					enabled.timelineSemaphore = true;
					continue;
				}
#endif
#ifdef VK_KHR_buffer_device_address
				...
				{
					enabled.bufferDeviceAddress = true;
					continue;
				}
#endif
#ifdef VK_KHR_shader_atomic_int64
				if (ext == VK_KHR_SHADER_ATOMIC_INT64_EXTENSION_NAME)
				{
					enabled.shaderAtomicInt64 = true;
					continue;
				}
#endif
#ifdef VK_KHR_shader_clock
				...
				{
					enabled.shaderClock = true;
					continue;
				}
#endif
#ifdef VK_EXT_extended_dynamic_state
				if (ext == VK_EXT_EXTENDED_DYNAMIC_STATE_EXTENSION_NAME)
				{
					enabled.extendedDynamicState = true;
					continue;
				}
#endif
#ifdef VK_KHR_ray_tracing
				if (ext == VK_KHR_RAY_TRACING_EXTENSION_NAME)
				{
					enabled.rayTracing = true;
					continue;
				}
#endif
			}
	  ...
	  =================================================
	  */
	bool VulkanDevice2Initializer::CreateLogicalDevice(ArrayView<QueueCreateInfo> queues, VkBool32 has_surface, VkBool32 can_present, ArrayView<const char*> extensions)
	{
		CHECK_ERR(_vkPhysicalDevice);
		CHECK_ERR(not _vkLogicalDevice);

		CHECK_ERR(_SetupQueues(queues, has_surface, can_present));
		...
		CHECK_ERR(_SetupQueueTypes(has_surface, can_present));
		return true;
	}
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::SetLogicalDevice(VkDevice newDevice, VkBool32 has_surface, VkBool32 can_present, ArrayView<const char*> extensions)
	{
		CHECK_ERR(_vkPhysicalDevice);
		CHECK_ERR(not _vkLogicalDevice);
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::DestroyLogicalDevice()
	{
	...
	=================================================
	*/
	void VulkanDevice2Initializer::_UpdateInstanceVersion(uint ver)
	{
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::_InitDeviceFeatures()
	{
		...
		_features.bindMemory2 = _vkVersion >= InstanceVersion{1, 1} or
								(HasDeviceExtension(VK_KHR_GET_MEMORY_REQUIREMENTS_2_EXTENSION_NAME) and HasDeviceExtension(VK_KHR_BIND_MEMORY_2_EXTENSION_NAME));
#endif
...
#endif
#ifdef VK_EXT_robustness2
			_features.robustness2 &=
				!!(_properties.robustness2Features.robustBufferAccess2 | _properties.robustness2Features.robustImageAccess2 | _properties.robustness2Features.nullDescriptor);
#endif
#ifdef VK_EXT_extended_dynamic_state
...
//}
		...
		FG_LOGI(
			...
			<< ToString(VK_VERSION_MINOR(_properties.properties.apiVersion)) << '.' << ToString(VK_VERSION_PATCH(_properties.properties.apiVersion))
			<< "\n  driverVersion:            " << ToString(VK_VERSION_MAJOR(_properties.properties.driverVersion)) << '.'
			<< ToString(VK_VERSION_MINOR(_properties.properties.driverVersion)) << '.' << ToString(VK_VERSION_PATCH(_properties.properties.driverVersion))
			<< "\n  ---------- 1.1 ----------"
			...
			<< "\n  shadingRateImageNV:       "
			<< ToString(_features.shadingRateImageNV)
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::_SetupQueueTypes(VkBool32 has_surface, VkBool32 can_present)
	{
		for (VQueueType t = Zero; t < VQueueType::_Count; t = VQueueType(uint(t) + 1))
		{
			...
			switch (t)
			{
			case VQueueType::Graphics:
				_AddGraphicsQueue(has_surface, can_present);
				break;
			case VQueueType::AsyncCompute:
				_AddAsyncComputeQueue();
				break;
			case VQueueType::AsyncTransfer:
				_AddAsyncTransferQueue();
				break;
			case VQueueType::_Count:
			case VQueueType::Unknown:
			default:
				CHECK(!"unknown queue type");
			}
			END_ENUM_CHECKS();
		}
		return true;
	...
	*/
	namespace
	{
		ND_ bool IsUniqueQueue(VulkanDevice2::VQueuePtr ptr, ArrayView<VulkanDevice2::VQueuePtr> qtypes)
		{
			for (auto& q : qtypes)
			{
				if (q == ptr)
	  ...
	  =================================================
	  */
	bool VulkanDevice2Initializer::_AddGraphicsQueue(VkBool32 has_surface, VkBool32 can_present)
	{
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::_AddAsyncComputeQueue()
	{
		VQueuePtr unique;
		VQueuePtr best_match;
		VQueuePtr compatible;
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::_AddAsyncTransferQueue()
	{
		VQueuePtr unique;
		VQueuePtr best_match;
		VQueuePtr compatible;
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::_ChooseQueueIndex(ArrayView<VkQueueFamilyProperties> queueFamilyProps, INOUT VkQueueFlagBits& requiredFlags, OUT uint& familyIndex) const
	{
		...
		for (size_t i = 0; i < queueFamilyProps.size(); ++i)
		{
			...
			if (AllBits(curr_flags, requiredFlags) and (compatible.first == 0 or BitCount(compatible.first) > BitCount(curr_flags)))
			{
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::_SetupQueues(ArrayView<QueueCreateInfo> queues, VkBool32 has_surface, VkBool32 can_present)
	{
		...
		if (queues.empty())
		{
			...
			vq.minImageTransferGranularity = {
				queue_family_props[family_index].minImageTransferGranularity.width, queue_family_props[family_index].minImageTransferGranularity.height,
				queue_family_props[family_index].minImageTransferGranularity.depth};

			if (has_surface)
			{
				vq.supportsPresent = can_present;
			}
		...
		QueueCount_t qcount;
		qcount.resize(queue_family_props.size());
	...
	=================================================
	*/
	void VulkanDevice2Initializer::_ValidateInstanceVersion(INOUT uint& version) const
	{
	...
	=================================================
	*/
	void VulkanDevice2Initializer::_ValidateInstanceLayers(INOUT Array<const char*>& layers) const
	{
	...
	=================================================
	*/
	void VulkanDevice2Initializer::_ValidateInstanceExtensions(INOUT Array<const char*>& extensions) const
	{
	...
	=================================================
	*/
	void VulkanDevice2Initializer::_ValidateDeviceExtensions(INOUT Array<const char*>& extensions) const
	{
	...
	=================================================
	*/
	void VulkanDevice2Initializer::_LogPhysicalDevices() const
	{
		uint							 count = 0;
		FixedArray<VkPhysicalDevice, 16> devices;
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::CreateDebugCallback(VkDebugUtilsMessageSeverityFlagsEXT severity, DebugReport_t&& callback)
	{
	...
	=================================================
	*/
	void VulkanDevice2Initializer::DestroyDebugCallback()
	{
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::GetMemoryTypeIndex(const uint memoryTypeBits, const VkMemoryPropertyFlags flags, OUT uint& memoryTypeIndex) const
	{
	...
	=================================================
	*/
	bool VulkanDevice2Initializer::CompareMemoryTypes(const uint memoryTypeBits, const VkMemoryPropertyFlags flags, const uint memoryTypeIndex) const
	{
		auto& mem_props = GetProperties().memoryProperties;
	...
	=================================================
	*/
	StringView VulkanDevice2Initializer::_ObjectTypeToString(VkObjectType objType)
	{
		BEGIN_ENUM_CHECKS();
		switch (objType)
		{
	...
	=================================================
	*/
	VKAPI_ATTR VkBool32 VKAPI_CALL VulkanDevice2Initializer::_DebugUtilsCallback(
		...
		void* pUserData)
	{
		auto* self = static_cast<VulkanDevice2Initializer*>(pUserData);
		...
		for (uint i = 0; i < pCallbackData->objectCount; ++i)
		{
			...
			self->_tempObjectDbgInfos[i] = {_ObjectTypeToString(obj.objectType), obj.pObjectName ? StringView{obj.pObjectName} : StringView{}, obj.objectHandle};
		}

		self->_DebugReport({self->_tempObjectDbgInfos, pCallbackData->pMessage, AllBits(messageSeverity, VK_DEBUG_UTILS_MESSAGE_SEVERITY_ERROR_BIT_EXT)});
		return VK_FALSE;
	}
	...
	=================================================
	*/
	void VulkanDevice2Initializer::_DebugReport(const DebugReport& msg)
	{
		if (_callback)
	...
	=================================================
	*/
	ArrayView<const char*> VulkanDevice2Initializer::_GetInstanceExtensions(InstanceVersion ver)
	{
	...
	=================================================
	*/
	ArrayView<const char*> VulkanDevice2Initializer::_GetDeviceExtensions(InstanceVersion ver)
	{
		if (ver >= InstanceVersion{1, 2})
	...
	=================================================
	*/
	ArrayView<const char*> VulkanDevice2Initializer::GetRecomendedInstanceLayers()
	{
		...
		static const char* instance_layers[] = {
			...
			// may be unsupported:
			"VK_LAYER_ARM_MGD", "VK_LAYER_ARM_mali_perf_doc"};
#else
	...
	=================================================
	*/
	ArrayView<const char*> VulkanDevice2Initializer::GetInstanceExtensions_v100()
	{
	...
	=================================================
	*/
	ArrayView<const char*> VulkanDevice2Initializer::GetInstanceExtensions_v110()
	{
		static const char* instance_extensions[] = {
#ifdef VK_KHR_surface
			VK_KHR_SURFACE_EXTENSION_NAME,
	...
	=================================================
	*/
	ArrayView<const char*> VulkanDevice2Initializer::GetInstanceExtensions_v120()
	{
		static const char* instance_extensions[] = {
#ifdef VK_KHR_surface
			VK_KHR_SURFACE_EXTENSION_NAME,
	...
	=================================================
	*/
	ArrayView<const char*> VulkanDevice2Initializer::GetDeviceExtensions_v100()
	{
	...
	=================================================
	*/
	ArrayView<const char*> VulkanDevice2Initializer::GetDeviceExtensions_v110()
	{
		static const char* device_extensions[] = {
#ifdef VK_KHR_swapchain
			VK_KHR_SWAPCHAIN_EXTENSION_NAME,
...
// Vendor specific extensions
	...
	=================================================
	*/
	ArrayView<const char*> VulkanDevice2Initializer::GetDeviceExtensions_v120()
	{
		static const char* device_extensions[] = {
#ifdef VK_KHR_swapchain
			VK_KHR_SWAPCHAIN_EXTENSION_NAME,
